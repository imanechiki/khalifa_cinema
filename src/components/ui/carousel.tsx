  ...
  return (
    <button
      ...
      className={cn(
        ...
        "h-16 w-16",
        "hover:scale-110 hover:text-yellow-500",
        "absolute",
        orientation === "horizontal"
          ? "-left-12 top-1/2 -translate-y-1/2"
          : "-top-12 left-1/2 -translate-x-1/2 rotate-90",
      ...
      {...props}
    >
      <ChevronLeft className="h-8 w-8 hover:scale-110 hover:text-yellow-500" />
      {/* <span className="sr-only">Previous slide</span> */}
    </button>
  );
});
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      {...props}
    >
      <ChevronRight className="h-8 w-8 hover:scale-110 hover:text-yellow-500" />
      {/* <span className="sr-only">Next slide</span> */}
    </button>
  );
});
